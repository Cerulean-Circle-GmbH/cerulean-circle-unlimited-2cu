...
you need root rights to do this. so either login as root or sudo the command
  ...
  6. follow the procedure in section '**start once local**' [https://2cu.atlassian.net/wiki/spaces/CCU/pages/38436869/ONCE+Documentation#Start-Once-Server-Local](https://2cu.atlassian.net/wiki/spaces/CCU/pages/38436869/ONCE+Documentation#Start-Once-Server-Local)
  7. [Run the application](https://2cu.atlassian.net/wiki/spaces/CCU/pages/38436869/ONCE+Documentation#Start-Once-Server-Local)
