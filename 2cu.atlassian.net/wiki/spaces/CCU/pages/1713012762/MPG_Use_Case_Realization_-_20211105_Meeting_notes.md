...
- **WODA**
  - [EAM](./2cu.atlassian.net/wiki/spaces/CCU/pages/[NEEDS_MANUAL_FIX]) incorporated in the programming language and environment for large scale
...
covering all Business Model aspects
  ...
  - [UCP](./2cu.atlassian.net/wiki/spaces/CCU/pages/[NEEDS_MANUAL_FIX]) Components for reusable drag & drop of IT assets
