...
[Test WODA Server Handover](https://2cu.atlassian.net/wiki/spaces/CCU/pages/1795555329/Test+WODA+Server+Handover)

[Infrastructure Value Stream](https://2cu.atlassian.net/wiki/spaces/CCU/pages/747372568/Infrastructure+Value+Stream)
...
- Live Server
  ...
  - [NEOM Structr Schema](https://2cu.atlassian.net/wiki/spaces/CCU/pages/1919713281/NEOM+Structr+Schema)
    - [https://test.wo-da.de:8083/structr/#schema](https://test.wo-da.de:8083/structr/#schema) (!!!)
  - [NEOM - WODA.test - infrastructure and servers](https://2cu.atlassian.net/wiki/spaces/CCU/pages/1879932936/NEOM+-+WODA.test+-+infrastructure+and+servers)
    - [Jenkins server on WODA.test](https://2cu.atlassian.net/wiki/spaces/CCU/pages/1880096773/Jenkins+server+on+WODA.test)
    - [PlantUML on WODA.test](https://2cu.atlassian.net/wiki/spaces/CCU/pages/1879769146/PlantUML+on+WODA.test)
